...
template<typename KeyType, typename ValueType, std::size_t Order> class Transaction;
...
public:
	...
	virtual BlobStoreObject<const ValueType> Delete(Transaction* transaction, const KeyType& key) = 0;
	virtual Iterator Search(BlobStoreObject<HeadNode> head, const KeyType& key) = 0;
};
